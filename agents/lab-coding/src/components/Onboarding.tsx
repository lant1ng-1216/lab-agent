...
import { LAB_PRODUCT_NAME, LAB_SECURITY_URL } from '../constants/labBrand.js';
...
export function Onboarding({
  ...
  const securityStep = <Box flexDirection="column" gap={1} paddingLeft={1}>
      ...
      <Box flexDirection="column" width={70}>
        ...
        <OrderedList>
          <OrderedList.Item>
            <Text>Lab Agent can make mistakes</Text>
            <Text dimColor wrap="wrap">
              You should always review Lab Code&apos;s responses, especially when
              <Newline />
              running code.
              <Newline />
            </Text>
  ...
  if (shouldOfferTerminalSetup()) {
    steps.push({
      ...
      component: <Box flexDirection="column" gap={1} paddingLeft={1}>
          <Text bold>Use {LAB_PRODUCT_NAME}&apos;s terminal setup?</Text>
