...
import { LAB_MARK_MIN_WIDTH, LAB_MARK_REPLY } from '../../constants/figures.js';
    ...
    default:
      {
        ...
        if ($[22] !== isSelected || $[23] !== shouldShowDot) {
          t4 = shouldShowDot && <NoSelect fromLeftEdge={true} minWidth={LAB_MARK_MIN_WIDTH}><Text color={isSelected ? "suggestion" : "text"}>{LAB_MARK_REPLY}</Text></NoSelect>;
          $[22] = isSelected;
          $[23] = shouldShowDot;
          $[24] = t4;
        } else {
