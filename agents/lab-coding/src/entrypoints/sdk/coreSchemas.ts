  ...
  z
    .object({
      ...
      memory: z
        ...
        .optional()
        .describe(
          "Scope for auto-loading agent memory files. 'user' - Lab Agent profile, 'project' - .lab-agent/agent-memory/<agentType>/, 'local' - Lab Agent profile's per-project private storage",
        ),
      effort: z
