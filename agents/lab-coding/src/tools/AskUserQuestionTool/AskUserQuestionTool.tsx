...
import { LAB_MARK_QUESTION } from 'src/constants/figures.js';
...
function AskUserQuestionResultMessage(t0) {
  ...
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = <Box flexDirection="row"><Text color={getModeColor("default")}>{LAB_MARK_QUESTION} </Text><Text>User answered Lab Code's questions:</Text></Box>;
    $[0] = t1;
  } else {
    t1 = $[0];
  }
...
export const AskUserQuestionTool: Tool<InputSchema, Output> = buildTool({
  ...
  renderToolUseRejectedMessage() {
    return <Box flexDirection="row" marginTop={1}>
        <Text color={getModeColor('default')}>{LAB_MARK_QUESTION}&nbsp;</Text>
