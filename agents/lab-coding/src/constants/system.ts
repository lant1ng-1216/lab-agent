...
import {
  LAB_IDENTITY_PREFIX,
  LAB_SDK_IDENTITY_PREFIX,
} from './labBrand.js'

const DEFAULT_PREFIX = LAB_IDENTITY_PREFIX
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = LAB_SDK_IDENTITY_PREFIX
const AGENT_SDK_PREFIX = LAB_SDK_IDENTITY_PREFIX
